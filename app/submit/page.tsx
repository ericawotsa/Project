...
export default function Submit() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-purple-900 via-purple-800 to-purple-700">
      {/* Header */}
        ...
        <div className="max-w-4xl mx-auto px-6 py-6 text-center">
          ...
          <nav>
            <ul className="flex flex-wrap justify-center gap-6 text-gray-300">
              ...
              <li>
                <Link href="/memories" className="hover:text-blue-400 transition duration-200">
                  Memories
                </Link>
              </li>
              <li>
      ...
      <main className="flex-grow max-w-4xl mx-auto px-6 py-8">
        {submitted ? (
          <div className="bg-gradient-to-r from-green-700 to-green-600 text-gray-100 p-8 rounded-lg shadow-lg text-center animate-fade-in">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 bg-gray-800/90 p-8 rounded-lg shadow-xl">
            ...
            <div className="animate-slide-up">
              ...
              <input
                ...
                required
                className="w-full mt-2 p-3 border border-gray-600 rounded-lg focus:outline-none focus:border-blue-400 transition duration-200 bg-gray-700 text-gray-100"
              />
            </div>
            ...
            <div className="text-center animate-slide-up delay-600">
              <button
                type="submit"
                className="px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-lg shadow-md hover:from-blue-500 hover:to-blue-600 transition duration-200"
              >
                Submit Memory
              </button>
            </div>
